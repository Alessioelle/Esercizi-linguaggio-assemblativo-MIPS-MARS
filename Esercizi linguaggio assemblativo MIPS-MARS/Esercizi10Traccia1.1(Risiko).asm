...
syscall
li $v0,4
la $a0,carrigialli                       #Inserisco numero di carri gialli e lo salvo nel registro $t0 (difesa)
syscall
li $v0,5
syscall
move $t1,$v0

lanciodadi:                              #Genero 3 numeri casuali compresi tra 0 e 6 che simulano il lancio di tre dadi per l'attacco e li metto in vettoreattacco ordinati
li $t3,6                            
move $a1,$t3
li $v0,42                                
syscall
...
la $t2,vettoredifesa                     #Genero 3 numeri casuali compresi tra 0 e 6 che simulano il lancio di tre dadi per la difesa e li metto in vettoredifesa ordinati
move $a1,$t3
li $v0,42
syscall
sw $a0,vettoredifesa
